...
// 			loadBmbm('bd','标段');
			...
			$.ajax({
				...
				success:function(data){
					$.each(data,function(index,item){
						$('#zjdw_table_tbody').append('<tr name="'+$.cookie("unit")+'" id="'+item.id+'"><td align="center">'+item.name+'</td><td align="center"><input type="number" width="60" /><font color="red"></font></td><td  align="center"><input type="number" width="60" /><font color="red"></font></td><td  align="center"><input type="number" width="60" /><font color="red"></font></td><td  align="center"><input type="number" width="60" /><font color="red"></font><input type="hidden" value="'+item.parent+'"/></td></tr>');
					});
				}
			});
		...
		function loadZj(gydwdm){
			...
			var zjq;
			if($.cookie("unit")=="36")
			zj={'gydwdm':"21101360000",'dwyf':$("#nf").combo('getValue')+"-"+$("#yf").combo('getValue'),'nf':$("#nf1").combo('getValue'),'jhxdwh':$("#jhxdwh").combo('getValue')};
