			    ...
			    columns:[[	{field:'allSel',title:'全选',width:60,align:'center',rowspan:1,checkbox:'true'},
							{field:'cz',title:'操作',width:130,align:'center',
								formatter: function(value,row,index){
									var result='<a style="color:#3399CC;" href="javascript:openXmInfo('+"'"+row.xmbm+"','nc_gljs','zjdw'"+')" >项目详情</a>&nbsp;';
									result+='<a style="color:#3399CC;" href="javascript:openZjdw('+"'"+row.xmbm+"','"+row.gydwdm+"','nc_gljs'"+')" >到位详情</a>';	
									return result;
								}
							},
...
<body>
	<div id="righttop">
		<div id="p_top">资金到位>&nbsp;农村公路>&nbsp;农村公路建设</div>
	</div>
