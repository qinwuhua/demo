			    ...
			    columns:[[	{field:'allSel',title:'全选',width:60,align:'center',rowspan:1,checkbox:'true'},
							{field:'cz',title:'操作',width:120,align:'center',
								formatter: function(value,row,index){
									...
									result+='<a style="color:#3399CC;" href="javascript:openZjbf('+"'"+row.xmbm+"','"+row.gydwdm+"','nc_lwjggz'"+')" >拨付详情</a>';	
									return result;
								}
							},
...
<body>
	<div id="righttop">
		<div id="p_top">资金拨付>&nbsp;农村公路>&nbsp;路网结构改造</div>
	</div>
...
<!--         						<td><input name="xmbm" type="text" id="xmbm" style="width:140px;" /></td> -->
								...
								<td><select name="sfqbbf" id="sfqbbf" style="width:44px;" ></select></td>
