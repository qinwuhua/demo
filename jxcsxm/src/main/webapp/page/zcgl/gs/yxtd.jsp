...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function queryXmlist(){
			...
			var params={'gydw':xzqhstr,'xmlx':'yxtd','sbthcd':$.cookie('unit2').length,
					   'nf':$("#nf").combobox('getValue'),'wz':$("#wz").val(),
			...
			var columns;
				...
				columns=[[	{field:'allSel',title:'全选',width:50,align:'center',rowspan:1,checkbox:'true'},
					...
					{field:'wz',title:'位置',width:250,align:'center'},
					{field:'mj',title:'面积（平方米）',width:100,align:'center'},
		...
		function loadTj(){
		 ...
		 function addInfo(){
			 ...
			 YMLib.UI.createWindowFj('mywin',"添加","/jxcsxm/page/zcgl/gs/yxtd_tj.jsp",'mywin',850,400);	
		 }	
		function copyInfo(){
			$("#win").window('open');
			$("#win").show();
		...
		function openZcgl(id,flag){
			YMLib.Var.index=id;
			if(flag=='bj')
				openWindow("编辑","/jxcsxm/page/zcgl/gs/yxtd_bj.jsp",850,400);	
			if(flag=='info')
				openWindow("详情","/jxcsxm/page/zcgl/gs/yxtd_info.jsp",850,350);
		}
