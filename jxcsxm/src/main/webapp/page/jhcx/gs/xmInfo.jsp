...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function openDwInfo(id){
		YMLib.Var.id=id;
		if(parent.YMLib.Var.xmlx=="gs_gsdgz")
		openWindow("详情","/jxcsxm/page/zjdw/gs/gsdgzzjdw_info.jsp",600,345);
		if(parent.YMLib.Var.xmlx=="gs_yhdzx")
		openWindow("详情","/jxcsxm/page/zjdw/gs/yhdzxzjdw_info.jsp",600,275);
		if(parent.YMLib.Var.xmlx=="gs_zhhf")
		openWindow("详情","/jxcsxm/page/zjdw/gs/zhhfzjdw_info.jsp",600,345);
		if(parent.YMLib.Var.xmlx=="gs_lwjggz")
		openWindow("详情","/jxcsxm/page/zjdw/gs/lwjggzzjdw_info.jsp",600,245);
		if(parent.YMLib.Var.xmlx=="nc_lwjggz")
		openWindow("详情","/jxcsxm/page/zjdw/nc/lwjggzzjdw_info.jsp",600,245);
		if(parent.YMLib.Var.xmlx=="nc_gljs"||parent.YMLib.Var.xmlx=='nc_tzrc'||parent.YMLib.Var.xmlx=='nc_yhgc')
		openWindow("详情","/jxcsxm/page/zjdw/nc/nczjdw_info.jsp",600,245);
