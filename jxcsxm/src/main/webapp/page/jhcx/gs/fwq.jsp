...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function queryXmlist(){
			...
			var params={'xmjbxx.xmbm':'','xmjbxx.xzqh':xzqhstr,'xmjbxx.jsxz':jsxz,'xmjbxx.knw':'',
			...
			$('#grid').datagrid({    
			    ...
			    columns:[[	{field:'cz',title:'操作',width:130,align:'center',
							formatter: function(value,row,index){
								var result='<a style="color:#3399CC;" href="javascript:openXmInfo('+"'"+row.xmbm+"','gs_fwq','jhcx'"+')" >项目详情</a>'
									return result;
							}
							},
...
<body>
	<div id="righttop">
		<div id="p_top">计划查询>&nbsp;普通国省道>&nbsp;服务区</div>
	</div>
