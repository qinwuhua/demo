...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function queryXmlist(){
			...
			var params={'xmjbxx.xmbm':'','xmjbxx.xzqh':xzqhstr,'xmjbxx.jsxz':jsxz,'xmjbxx.knw':'','xmjbxx.gydw':2,
			...
			$('#grid').datagrid({    
			    ...
			    columns:[[	{field:'cz',title:'操作',width:130,align:'center',
							formatter: function(value,row,index){
								var result='<a style="color:#3399CC;" href="javascript:openXmInfo('+"'"+row.xmbm+"','gs_lwjggz','jhcx'"+')" >项目详情</a>'
									return result;
							}
							},
...
// 							{field:'xmbm',title:'项目编码',width:110,align:'center'},
		...
		function loadTj(){
			...
			var params={'xmjbxx.sbthcd':$.cookie("unit2").length,'xmjbxx.xmbm':'','xmjbxx.xzqh':xzqhstr,'xmjbxx.jsxz':jsxz,'xmjbxx.knw':'','xmjbxx.gydw':2,
					   'xmjbxx.xmnf':xmnf,'xmjbxx.xmmc':$("#xmmc").val(),'xmjbxx.jhxdwh':jhxdwh,
					   'xmjbxx.gcfl':gcfl
			};
			$.ajax({
...
<body>
	<div id="righttop">
		<div id="p_top">计划查询>&nbsp;普通国省道>&nbsp;路网结构改造</div>
	</div>
