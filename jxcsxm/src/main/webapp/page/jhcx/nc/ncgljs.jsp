...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function loadTj(){
			...
			var params={'xmjbxx.sbthcd':$.cookie("unit2").length,'xmjbxx.xmbm':$("#xmbm").val(),'xmjbxx.xzqh':xzqhstr,'xmjbxx.jsxz':jsxz,'xmjbxx.knw':'','xmjbxx.gcfl':getValuesById("gcfl"),
					   'xmjbxx.xmnf':xmnf,'xmjbxx.xmmc':$("#xmmc").val(),'xmjbxx.jhxdwh':jhxdwh,'xmjbxx.gydwdm':gydwstr
			};
			$.ajax({
				type:'post',
...
<body>
	<div id="righttop">
		<div id="p_top">计划查询>&nbsp;农村公路>&nbsp;农村公路建设</div>
	</div>
