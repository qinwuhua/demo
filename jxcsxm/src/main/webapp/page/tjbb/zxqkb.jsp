...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function showBb(){
		...
		$.ajax({
			...
			data:'flag=0&nf='+nf+"&gydw="+xzqhstr+"&yf="+yf+"&xmlx="+"zxqkb",
			type:"post",
			dataType:"JSON",
	...
	function exportBb(){
		...
		var data='flag=1&nf='+nf+"&gydw="+xzqhstr+"&yf="+yf+"&xmlx="+"zxqkb";
		loadjzt();
	...
	function importBb(){
		...
		var weatherDlg = new J.dialog( {
			id : 'ids',
			title : '请选择EXCEL文档！',
			page : './uploadwjbb.jsp?url='+url+'&flag='+'zxqkb',
			width : 450,
			height : 400,
			top : 0,
			rang : true,
                		...
                		<div class="easyui-layout"  fit="true">
							...
							<table id='bbtable' width="100%">
								...
								<tbody id='biaotou'>
									...
									<tr>
									<td rowspan="2" width="20%">项        目</td>
									<td rowspan="2" width="10%">行次</td>
									<td rowspan="2" width="10%">上年结转</td>
									<td colspan="4" width="40%">本年预算数</td>
									<td rowspan="2" width="10%">本年实际支出</td>
									<td rowspan="2" width="10%">本年结转</td>
									
									</tr>
									<tr>
									<td width="10%">养路补助</td>
									<td width="10%">车购税补助</td>
									<td width="10%">其他来源</td>
									<td width="10%">合计</td>
									</tr>
