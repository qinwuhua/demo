...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function showBb(){
		...
		$.ajax({
			...
			data:'flag=0&nf='+nf+"&gydw="+xzqhstr+"&xmlx="+getValuesById("xmlx"),
			type:"post",
			dataType:"JSON",
	...
	function exportBb(){
		...
		var nf=$("#nf").combobox('getValue');
		var gydw="";if($.cookie('unit').substr(0,1)=='1') gydw='1';if($.cookie('unit').substr(0,1)=='2') gydw='2';
		var data="flag=1&nf="+nf+"&xmlx="+getValuesById("xmlx");
		loadjzt();
            ...
            <tr>
            	<td style="padding-top: 10px;padding-left:10px;padding-right:10px;">
                	<div id="gddiv" style="width:100%;height: 450px;" >
                		<script type="text/javascript">
                			$("#gddiv").attr('style','width:4000px;height:'+($(window).height()-145)+'px;');
                		</script>
