...
<script type="text/javascript">
	$(function(){
		...
		$("#qx").bind("click", function () {
			...
			treeChecked(this,"tt5");
			
        }); 
		createJsontree('tt1','./js/tzhzb1.json'); 
		createBtTree('tt2','2','tzhzb'); 
		createBtTree('tt3','3','tzhzb'); 
		createBtTree('tt4','4','tzhzb'); 
		createJsontree('tt5','./js/tzhzb2.json'); 
	});
	...
	function search(){
		...
		for(var i=0;i<obj5.length;i++){
			if(obj5[i].id.indexOf('v_')!=-1){
				str+=obj5[i].id+"','";
				str1+=obj5[i].id.substring(obj5[i].id.indexOf('v_'))+",";
			}
		}
			...
			<td colspan="6" style="background-color: #ffffff; height: 200px;" >
				<table border="0" style="margin-top: 0">
					<tr>
						...
						<td valign="top">
						<ul id="tt5" style="margin-top: 1px;"></ul>  
						</td>
					</tr>
				</table>
			</td>
