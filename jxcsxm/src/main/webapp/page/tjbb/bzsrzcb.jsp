...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function showBb(){
		...
		$.ajax({
			...
			data:'flag=0&nf='+nf+"&gydw="+xzqhstr+"&yf="+yf+"&xmlx="+"bzsrzcb",
			type:"post",
			dataType:"JSON",
	...
	function exportBb(){
		...
		var data='flag=1&nf='+nf+"&gydw="+xzqhstr+"&yf="+yf+"&xmlx="+"bzsrzcb";
		loadjzt();
	...
	function importBb(){
		...
		var weatherDlg = new J.dialog( {
			id : 'ids',
			title : '请选择EXCEL文档！',
			page : './uploadwjbb.jsp?url='+url+'&flag='+'bzsrzcb',
			width : 450,
			height : 400,
			top : 0,
			rang : true,
...
<body>
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.9%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
					<div id="righttop">
						<div id="p_top">当前位置>&nbsp;统计报表>&nbsp;财政补助收入支出表</div>
					</div>
        	</tr>
        	<tr>
            	...
            	<td style="padding-top: 10px;padding-left:10px;padding-right:10px;">
                	<div id="gddiv" style="width:100%;height: 450px;" >
                		...
                		<div class="easyui-layout"  fit="true">
							...
							<div style="font-size:large;font-weight: bolder;" align="center">财政补助收入支出表</div>
							<div align="right">
									会事业03表
							</div>
							<div>
