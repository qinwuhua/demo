...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>公路建设省补资金使用情况汇总表（按单位统计）</title>
	...
	function showBb(){
		...
		$.ajax({
			url:"/jxcsxm/tjbb/getZjsydwsbhzb.do",
	...
	function exportBb(){
		...
		loadjzt();
		 $.post('/jxcsxm/xtgl/exportBb_set.do',{gydw:xzqhstr},function(){
			window.location.href='/jxcsxm/tjbb/getZjsydwsbhzb.do?'+data;
		 }); 
		...
		<table width="99.9%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
					<div id="righttop" style="width:2020px;">
						<div id="p_top">当前位置>&nbsp;统计报表>&nbsp;公路建设省补资金使用情况汇总表（按单位统计）</div>
					</div>
        	</tr>
        	<tr>
                	...
                	<div id="gddiv" style="width:100%;height: 450px;" >
                		...
                		<div class="easyui-layout"  fit="true">
							...
							<table id='bbtable' width="100%">
								<caption align="top" style="font-size:large;font-weight: bolder;"> 公路建设省补资金使用情况汇总表（按单位统计）</caption>
								<tbody id='biaotou'>
									<tr>
