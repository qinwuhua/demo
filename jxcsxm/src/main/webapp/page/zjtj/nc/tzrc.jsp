...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
			    ...
			    columns:[[	{field:'allSel',title:'全选',width:60,align:'center',rowspan:1,checkbox:'true'},
							{field:'cz',title:'操作',width:130,align:'center',
								formatter: function(value,row,index){
									var result='<a style="color:#3399CC;" href="javascript:openXmInfo('+"'"+row.xmbm+"','nc_tzrc','zjtj'"+')" >项目详情</a>&nbsp;';
									result+='<a style="color:#3399CC;" href="javascript:openZjtj('+"'"+row.xmbm+"','"+row.gydwdm+"','nc_tzrc'"+')" >调剂详情</a>';	
									return result;
								}
							},
		...
		function drsj(){
			var url="/jxcsxm/zjtj/importZjtj.do?gydwdm="+$.cookie("unit");
			var flag='tzrczjtj';
			importSj(url,flag);
		} 
		...
		//批量删除数据
		 function qbscbf(){
			 ...
			 if(confirm("按填报时间进行删除操作,删除后不可恢复,确认吗？")){
				 openWindow("删除","/jxcsxm/page/zjtj/zjtj_del.jsp",400,350);
			 }
		 }
...
<body>
	<div id="righttop">
		<div id="p_top">资金调剂>&nbsp;农村公路>&nbsp;通自然村</div>
	</div>
