			    ...
			    columns:[[	{field:'allSel',title:'全选',width:60,align:'center',rowspan:1,checkbox:'true'},
							{field:'cz',title:'操作',width:130,align:'center',
								formatter: function(value,row,index){
									var result='<a style="color:#3399CC;" href="javascript:openXmInfo('+"'"+row.xmbm+"','nc_gljs','zjtj'"+')" >项目详情</a>&nbsp;';
									result+='<a style="color:#3399CC;" href="javascript:openZjtj('+"'"+row.xmbm+"','"+row.gydwdm+"','nc_gljs'"+')" >调剂详情</a>';	
									return result;
								}
							},
...
<body>
	<div id="righttop">
		<div id="p_top">资金调剂>&nbsp;项目资金调剂>&nbsp;农村公路>&nbsp;农村公路建设</div>
	</div>
        			...
        			<fieldset id="searchField" style="width:99.9%; text-align: left; vertical-align: middle;">
        				...
        				<table style="margin:4px; vertical-align:middle;" cellspacing="0" class="abgc_td" >
        					...
        					<tr height="28">
								...
								<td><select name="gcfl" id="gcfl" style="width:165px;" ></select></td>
