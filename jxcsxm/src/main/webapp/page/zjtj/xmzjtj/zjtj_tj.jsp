...
$(function(){
	...
	$("#syktjzj").html(parent.$("#syktjzj").html());
...
function zjdwtj(){
	...
	if($('#jhxdwh1').val()==""||$('#jhxdwh1').val()==""||$('#jhxdwh1').val()==""){alert("请选择计划下达文号");return;}
...
<table class='table' style="width: 100%; background-color: #FFE7BA; font-size: 12px"
			...
			<tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 20px;width:30%" align="left">
					...
					<input type="hidden"  id="jhxdwh" style="width: 80px" />
					</td>
			...
			<tr style="height: 35px;">
				...
				项目年份：</td>
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<input type="text" name="xmnf1" id="xmnf1"  style="width: 181px" /></td>
			...
			<tr style="height: 35px;">
				...
				管养单位：</td>
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<input type="text" name="gydw1" id="gydw1"  style="width: 181px" />
				...
				行政区划：</td>
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<input type="text" name="xzqh1" id="xzqh1"  style="width: 181px" />
