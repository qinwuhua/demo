...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function queryXmlist(){
			...
			var params={'xmjbxx.sbthcd':$.cookie("unit2").length,'xmjbxx.xmbm':'','xmjbxx.xzqh':xzqhstr,'xmjbxx.jsxz':jsxz,'xmjbxx.knw':'',
			    ...
			    columns:[[	{field:'allSel',title:'全选',width:60,align:'center',rowspan:1,checkbox:'true'},
							{field:'cz',title:'操作',width:130,align:'center',
								formatter: function(value,row,index){
									var result='<a style="color:#3399CC;" href="javascript:openXmInfo('+"'"+row.xmbm+"','gs_fwq','zjtj'"+')" >项目详情</a>&nbsp;';
									result+='<a style="color:#3399CC;" href="javascript:openZjtj('+"'"+row.xmbm+"','"+row.gydwdm+"','gs_fwq'"+')" >调剂详情</a>';	
									return result;
								}
							},
...
<body>
	<div id="righttop">
		<div id="p_top">资金调剂>&nbsp;普通国省道>&nbsp;服务区</div>
	</div>
