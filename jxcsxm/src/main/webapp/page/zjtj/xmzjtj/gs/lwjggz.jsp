...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function queryXmlist(){
			...
			var params={'xmjbxx.sbthcd':$.cookie("unit2").length,'xmjbxx.xmbm':$("#xmbm").val(),'xmjbxx.xzqh':xzqhstr,'xmjbxx.gcfl':gcfl,'xmjbxx.jsxz':jsxz,'xmjbxx.knw':'','xmjbxx.gydw':2,
			    ...
			    columns:[[	{field:'allSel',title:'全选',width:60,align:'center',rowspan:1,checkbox:'true'},
							{field:'cz',title:'操作',width:120,align:'center',
								formatter: function(value,row,index){
									...
									result+='<a style="color:#3399CC;" href="javascript:openZjtj('+"'"+row.xmbm+"','"+row.gydwdm+"','gs_lwjggz'"+')" >调剂详情</a>';	
									return result;
								}
							},
...
<body>
	<div id="righttop">
		<div id="p_top">资金调剂>&nbsp;项目资金调剂>&nbsp;普通国省道>&nbsp;路网结构改造</div>
	</div>
