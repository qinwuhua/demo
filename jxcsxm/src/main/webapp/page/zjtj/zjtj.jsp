...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function zjtjtj(){
			...
			openWindow("添加","/jxcsxm/page/zjtj/gs/gsdgzzjtj_tj.jsp",600,385);
			if(parent.YMLib.Var.xmlx=="gs_yhdzx")
			openWindow("添加","/jxcsxm/page/zjtj/gs/yhdzxzjtj_tj.jsp",600,275);
			if(parent.YMLib.Var.xmlx=="gs_zhhf")
			openWindow("添加","/jxcsxm/page/zjtj/gs/zhhfzjtj_tj.jsp",600,345);
			if(parent.YMLib.Var.xmlx=="gs_lwjggz")
			openWindow("添加","/jxcsxm/page/zjtj/gs/lwjggzzjtj_tj.jsp",600,275);
			if(parent.YMLib.Var.xmlx=="nc_lwjggz")
			openWindow("添加","/jxcsxm/page/zjtj/nc/lwjggzzjtj_tj.jsp",600,275);
			if(parent.YMLib.Var.xmlx=="nc_gljs"||parent.YMLib.Var.xmlx=="nc_tzrc"||parent.YMLib.Var.xmlx=="nc_yhgc")
			openWindow("添加","/jxcsxm/page/zjtj/nc/nczjtj_tj.jsp",600,275);
			if(parent.YMLib.Var.xmlx=="gs_sfl")
				openWindow("添加","/jxcsxm/page/zjtj/gs/sflzjtj_tj.jsp",600,275);	
			if(parent.YMLib.Var.xmlx=="gs_fwq")
				openWindow("添加","/jxcsxm/page/zjtj/gs/fwqzjtj_tj.jsp",600,275);	
			if(parent.YMLib.Var.xmlx=="gs_yhzx")
				openWindow("添加","/jxcsxm/page/zjtj/gs/yhzxzjtj_tj.jsp",600,295);	
