...
<script type="text/javascript">
	...
	function fanhui() {
		...
		if(flag==1){
			parent.window.location = '/jxcsxm/page/qqgl/jhsh/lmsj.jsp';
		}
		if(flag==2){
			parent.window.location = '/jxcsxm/page/qqgl/jhsh/lmgz.jsp';
		}
		if(flag==3){
			parent.window.location = '/jxcsxm/page/qqgl/jhsh/xjgc.jsp';
		}
		if(flag==4){
			parent.window.location = '/jxcsxm/page/qqgl/zjxd/lmsj.jsp';
		}
		if(flag==5){
			parent.window.location = '/jxcsxm/page/qqgl/zjxd/lmgz.jsp';
		}
		if(flag==6){
			parent.window.location = '/jxcsxm/page/qqgl/zjxd/xjgc.jsp';
		}
		if(flag=="yhlxsh"){
